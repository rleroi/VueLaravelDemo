...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    index: function index() {
      ...
      axios.get('/api/articles').then(function (r) {
        _this.$data.articles = r.data;
      }).catch(function (e) {
        console.error('Error getting articles.', e);
      });
    },
    deleteArticle: function deleteArticle(id, index) {
      var _this2 = this;

      axios.delete('/api/articles/' + id).then(function (r) {
        if (r.status == 204) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getCategories: function getCategories() {
      ...
      axios.get('/api/categories').then(function (r) {
        _this.$data.categories = r.data;
      }).catch(function (e) {
    ...
    getArticle: function getArticle(id) {
      ...
      axios.get('/api/articles/' + id).then(function (r) {
        if (r.status == 200) {
          // remove timestamps (we are not editing these)
          delete r.data.created_at;
          delete r.data.updated_at; // set data

          _this2.$data.article = r.data;
        }
      }).catch(function (e) {
    ...
    createArticle: function createArticle(article) {
      ...
      console.log("Attempting to create ".concat(article.subject)); // create urlencoded querystring format

      var queryString = Object.keys(this.$data.article).map(function (key) {
        return encodeURIComponent(key) + '=' + encodeURIComponent(_this3.$data.article[key]);
      }).join('&');
      axios.post('/api/articles', queryString).then(function (r) {
    ...
    updateArticle: function updateArticle(article) {
      ...
      console.log("Attempting to update ".concat(article.subject)); // create urlencoded querystring format with article ID appended

      var queryString = Object.keys(this.$data.article).map(function (key) {
        return encodeURIComponent(key) + '=' + encodeURIComponent(_this4.$data.article[key]);
      }).join('&');
      axios.put('/api/articles/' + this.$route.params.id, queryString).then(function (r) {
        if (r.status = 200) {
          _this4.$router.push('/');
        }
      }).catch(function (e) {
    ...
    createOrUpdateArticle: function createOrUpdateArticle(article) {
...
var render = function() {
  ...
  return _c(
    "nav",
    { staticClass: "navbar navbar-expand-lg fixed-top navbar-light bg-light" },
    [
      _c("router-link", { staticClass: "navbar-brand", attrs: { to: "/" } }, [
        _vm._v("LARA"),
        _c("span", { staticClass: "light" }, [_vm._v("CRUD")])
      ]),
      _vm._v(" "),
      _vm._m(0),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "collapse navbar-collapse", attrs: { id: "mainNav" } },
        ...
        _vm.articles.length
          ...
          : _c("div", { staticClass: "col-md-12" }, [
              _c(
                "p",
                [
                  _vm._v("Geen artikelen. "),
                  _c("router-link", { attrs: { to: "/new" } }, [
                    _vm._v("Artikel toevoegen")
                  ]),
                  _vm._v(".")
                ],
                1
...
var render = function() {
  ...
  return _c("div", { staticClass: "new" }, [
    _vm.$route.params.id
      ? _c("h3", [_vm._v("Artikel bewerken")])
      : _c("h3", [_vm._v("Artikel toevoegen")]),
    _vm._v(" "),
    _c(
      "form",
      {
        on: {
          submit: function($event) {
            _vm.createOrUpdateArticle(_vm.article)
          }
        }
      },
      [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "subject" } }, [_vm._v("Onderwerp")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.article.subject,
                expression: "article.subject"
              }
            ],
            ...
            domProps: { value: _vm.article.subject },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.article, "subject", $event.target.value)
              }
            }
          })
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "author" } }, [_vm._v("Auteur")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "category_id" } }, [_vm._v("Categorie")]),
          _vm._v(" "),
          _c(
            "select",
            {
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "body" } }, [_vm._v("Artikel")]),
          _vm._v(" "),
          _c("textarea", {
            directives: [
              {
            ...
            staticClass: "form-control",
            attrs: { placeholder: "Artikel", id: "body", required: "" },
        ...
        _c("input", {
          ...
          attrs: { type: "submit" },
          domProps: { value: _vm.$route.params.id ? "Opslaan" : "Toevoegen" }
        })
      ]
    )
  ])
        ...
        _c("h3", [
          ...
          _c("small", { staticClass: "text-muted" }, [
            ...
            _c("span", { staticClass: "badge badge-pill badge-secondary" }, [
              _vm._v(_vm._s(_vm.article.author))
            ])
          ])
        ]),
        _vm._v(" "),
        _c("p", { staticClass: "lead" }, [
          _vm._v("Op " + _vm._s(_vm.parseDate(_vm.article.created_at)) + " "),
          typeof _vm.article.category != "undefined"
            ? _c("span", [
                _vm._v("in "),
                _c("span", { staticClass: "badge badge-pill badge-primary" }, [
                  _vm._v(_vm._s(_vm.article.category.title))
                ])
              ])
            : _vm._e()
        ])
...
/* harmony import */ var _views_New_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/New.vue */ "./resources/js/views/New.vue");
/* harmony import */ var _views_View_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/View.vue */ "./resources/js/views/View.vue");
...
var routes = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/new',
    name: 'new',
    component: _views_New_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  }, {
    path: '/edit/:id',
    name: 'edit',
    component: _views_New_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
    ...
    path: '/view/:id',
    name: 'view',
    component: _views_View_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  }]
});
...
__webpack_require__(/*! /var/www/crud-vue/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/crud-vue/resources/sass/app.scss */"./resources/sass/app.scss");
